...
$sql = "INSERT INTO `sneakers`.`cart` (`name`, `phone no.`, `adress`) VALUES ('$name', '$phone', '$adress')"
...
<body>
    ...
    <div class="product" id="product">
        ...
        <div class="payment">
            ...
            <input type="text" name = "name" id = "name" placeholder="Name *" class="payInput">
            <label>Phone Number</label>
            <input type="text" name = "phone" id = "phone" placeholder="Mobile *" class="payInput">
            <label>Address</label>
            <input type="text" name = "adress" id = "adress" placeholder="Address (House no,Building,Street,Area)*" class="payInput">
    ...
    <div class="newSeason">
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu">
                <span class="copyright">@shoecollection All rights reserved. 2022.</span>
            </div>
        </div>
    </footer>
